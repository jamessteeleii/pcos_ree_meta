...
$$
\hat{\theta}_{ijkl} \sim \mathcal{N}(\mu_{ijkl}, \sigma^2_{ijkl})
$$
...
+ \alpha_{0,\mathrm{lab}[i]} + \alpha_{1,\mathrm{lab}[i]}\,\text{cond} 
+ \alpha_{0,\mathrm{study}[j]} + \alpha_{1,\mathrm{study}[j]}\,\text{cond} 
+ \alpha_{0,\mathrm{arm}[k]} + \alpha_{0,\mathrm{effect}[l]}
$$
...
\Sigma_{\mathrm{lab}} =
\begin{pmatrix}
\sigma^2_{0,\mathrm{lab}} & \rho_{\mathrm{lab}} \sigma_{0,\mathrm{lab}} \sigma_{1,\mathrm{lab}} \\
\rho_{\mathrm{lab}} \sigma_{0,\mathrm{lab}} \sigma_{1,\mathrm{lab}} & \sigma^2_{1,\mathrm{lab}}
\end{pmatrix},
\text{ for lab } i = 1, \dots, I
$$

$$
\begin{pmatrix}
\alpha_{0,\mathrm{study}[j]} \\
\alpha_{1,\mathrm{study}[j]}
\end{pmatrix}
\sim 
\mathcal{N}\Bigg(
...
\Sigma_{\mathrm{study}} =
\begin{pmatrix}
\sigma^2_{0,\mathrm{study}} & \rho_{\mathrm{study}} \sigma_{0,\mathrm{study}} \sigma_{1,\mathrm{study}} \\
\rho_{\mathrm{study}} \sigma_{0,\mathrm{study}} \sigma_{1,\mathrm{study}} & \sigma^2_{1,\mathrm{study}}
\end{pmatrix},
\text{ for study } j = 1, \dots, J
$$

$$
\alpha_{0,\mathrm{arm}[k]} \sim \mathcal{N}(0, \sigma^2_{0,\mathrm{arm}}), 
\text{ for arm } k = 1, \dots, K
$$

$$
\alpha_{0,\mathrm{effect}[l]} \sim \mathcal{N}(0, \sigma^2_{0,\mathrm{effect}}), 
\text{ for effect } l = 1, \dots, L
$$
...
$$
\beta_0 \sim \text{Student-}t(3, 1441.81, 84.56) \\
\beta_1 \sim \text{Student-}t(3, 0, 200)
$$

$$
\sigma^2_{0,\mathrm{study}} \sim \text{Half-student-}t(3, 149.89, 82.91) \\
\sigma^2_{0,\mathrm{lab}},\, \sigma^2_{1,\mathrm{lab}},\, 
\sigma^2_{1,\mathrm{study}},\, \sigma^2_{0,\mathrm{arm}},\, \sigma^2_{0,\mathrm{effect}} \sim \text{Half-student-}t(3, 0, 112.4)
$$

$$
\mathrm{corr}_{\mathrm{lab}} \sim \mathrm{LKJ}(1) \\
\mathrm{corr}_{\mathrm{study}} \sim \mathrm{LKJ}(1)
$$
...
$$
\log(\hat{\theta}_{ijkl}) \sim \mathcal{N}(\mu_{ijkl}, \sigma^2_{ijkl})
$$
...
$$
m = \log(y_{i,\mathrm{mean,[ijkl]}})
$$

$$
\tilde{m} \sim \mathcal{N}(m, \sigma_{\log(y_{i,\mathrm{mean,[ijkl]}})}^2)
$$
...
$$
\beta_0 \sim \text{Student-}t(3, 5.54, 0.80) \\
\beta_1 \sim \text{Student-}t(3, 0, 5.3) \\
\beta_2 \sim \text{Student-}t(3, 0, 2.5)
$$

$$
\text{mean}(\tilde{m}) \sim \text{Half-student-}t(3, 7.28, 0.62) \\
\text{sd}(\tilde{m}) \sim \text{Half-student-}t(3, 0, 5)
$$

$$
\sigma^2_{0,\mathrm{study}} \sim \text{Half-student-}t(3, 1.08, 1.06) \\
\sigma^2_{0,\mathrm{lab}},\, \sigma^2_{1,\mathrm{lab}},\, 
\sigma^2_{1,\mathrm{study}},\, \sigma^2_{0,\mathrm{arm}},\, \sigma^2_{0,\mathrm{effect}} 
\sim \text{Half-student-}t(3, 0, 2.5)
$$
...
$$
\hat{\theta}_{ij} \sim \mathcal{N}(\mu_{ij}, \sigma^2_{ij})
$$

$$
\mu_{ij} = \beta_0 + \alpha_{0,\mathrm{lab}[i]} + \alpha_{0,\mathrm{study}[j]}
$$
