...
As a further sensitivity analysis, given the inclusion of some studies with interventions in women with PCOS reporting REE at multiple timepoints [@moranShorttermMealReplacements2006; @brunerEffectsExerciseNutritional2006; @pohlmeierEffectLowstarchLowdairy2014] but the lack of control women without PCOS, we opted to also conduct sensitivity analysis excluding these and only examining cross-sectional studies. As such, the main models described above were run with and without these studies. 
