...
examining energy expenditure in women with PCOS\textsuperscript{30}.
...
Meta-Analyses (PRISMA) statement guidelines\textsuperscript{31}. The
PRISMA flow diagram reported below (Figure~\ref{fig-prisma}) was
produced using the \texttt{PRISMA2020} R package and Shiny
app\textsuperscript{32}. The primary aim of this review was to examine
...
information using the methods of Wan et al.\textsuperscript{34}.
...
case\textsuperscript{35} REE was reported relative to body mass and the
...
lab/research group\textsuperscript{13,36--38} contained a number of
...
studies\textsuperscript{36--38}, and REE was reported as an ``adjusted''
value whereby
...
\texttt{grateful} package\textsuperscript{39} which can be seen here:
...
estimation\textsuperscript{40} within a Bayesian meta-analytic
framework\textsuperscript{41}. For all analyses model parameter
...
context of each model. The \texttt{renv} package\textsuperscript{42} was
used for package version reproducibility and a function based analysis
pipeline using the \texttt{targets} package\textsuperscript{43} was
...
function\textsuperscript{44}. The main package
\texttt{brms}\textsuperscript{45} was used in fitting all the Bayesian
meta-analysis models. Prior and posterior draws were taken using
\texttt{marginaleffects}\textsuperscript{46} and
\texttt{tidybayes}\textsuperscript{47} packages. All visualisations are
created using \texttt{ggplot2}\textsuperscript{48}, \texttt{tidybayes},
and the \texttt{patchwork}\textsuperscript{49} packages.
...
both with, and without, a non-PCOS control arm\textsuperscript{50}, and
...
manner in meta-analyses\textsuperscript{33}. From this model we focus on
...
healthy people\textsuperscript{51,52} though set with a conservative
...
women from two large studies of healthy people\textsuperscript{51,52}
...
mean\textsuperscript{53} we set this prior to reflect the range of
...
resolve\textsuperscript{13,36--38}. Thus the main models described above
...
timepoints such as mid- and post-intervention\textsuperscript{35,54,55}
...
al.\textsuperscript{37}. The PRISMA flow diagram
...
PCOS\textsuperscript{16,17,35,54--61}. One study used the 1990 National
Institutes of Health criteria\textsuperscript{62}, and two
studies\textsuperscript{18,56} diagnosed PCOS via the presence of
...
scanning. All but one study\textsuperscript{62}, which used doubly
...
reporting issues that were not resolved\textsuperscript{13,36--38} still
...
from studies involving interventions\textsuperscript{35,54,55}, in
...
others\textsuperscript{36--38} have numerous reporting errors which led
...
analysis\textsuperscript{63} reported that, whilst there was little
...
complications like obesity and insulin resistance\textsuperscript{64}.
...
eating in this population\textsuperscript{21,22,65,66}. The pathways
...
cravings, and appetite variability\textsuperscript{67}. Frequent
hypoglycaemia and associated mood changes have also been observed, which
can trigger compensatory eating or binge episodes\textsuperscript{67}.
...
eating\textsuperscript{68}. Moreover, eating disorders themselves can
disrupt endocrine function, potentially worsening PCOS symptoms and
creating a self-reinforcing cycle\textsuperscript{66,69}.
...
failure, hunger dysregulation, and shame\textsuperscript{70}. These
...
could not be clarified (e.g.,\textsuperscript{13,36--38}) and were
