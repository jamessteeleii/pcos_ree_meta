...
Corresponding author: (Email: james@steele-research.com; ORCID:
0000-0002-8003-0757) James Steele, Steele Research Limited, 2 Sydney
Road, Eastleigh, Hampshire, SO50 6DJ, UK

Keywords: Polycystic ovary syndrome, Energy Metabolism, Resting
...
\subsection{Financial Disclosures/Conflicts of
...
recommended\textsuperscript{25,26}. It has been well documented that
women with PCOS already experience higher rates of anxiety, depression,
and lower quality of life (QOL) as a result of negative body image and
weight-related concerns\textsuperscript{27--30}. Clarifying the
...
A recent scoping review has highlighted the inconsistency in research
examining energy expenditure in women with PCOS\textsuperscript{31}.
However, to our knowledge there has been no attempts to systematically
review, and quantitatively synthesise via meta-analysis, studies of REE
in women with, and without, PCOS. Therefore, to estimate and describe
the magnitude of difference in REE between women with and without PCOS,
we completed a systematic review and meta-analysis of studies reporting
REE in these populations.
...
Meta-Analyses (PRISMA) statement guidelines\textsuperscript{32}. The
PRISMA flow diagram reported below (Figure~\ref{fig-prisma}) was
produced using the \texttt{PRISMA2020} R package and Shiny
app\textsuperscript{33}. The primary aim of this review was to examine
...
information using the methods of Wan et al.\textsuperscript{35}.
...
case\textsuperscript{36} REE was reported relative to body mass and the
...
lab/research group\textsuperscript{13,37--39} contained a number of
...
studies\textsuperscript{37--39}, and REE was reported as an ``adjusted''
value whereby
...
\texttt{grateful} package\textsuperscript{40} which can be seen here:
...
estimation\textsuperscript{41} within a Bayesian meta-analytic
framework\textsuperscript{42}. For all analyses model parameter
...
context of each model. The \texttt{renv} package\textsuperscript{43} was
used for package version reproducibility and a function based analysis
pipeline using the \texttt{targets} package\textsuperscript{44} was
...
function\textsuperscript{45}. The main package
\texttt{brms}\textsuperscript{46} was used in fitting all the Bayesian
meta-analysis models. Prior and posterior draws were taken using
\texttt{marginaleffects}\textsuperscript{47} and
\texttt{tidybayes}\textsuperscript{48} packages. All visualisations are
created using \texttt{ggplot2}\textsuperscript{49}, \texttt{tidybayes},
and the \texttt{patchwork}\textsuperscript{50} packages.
...
both with, and without, a non-PCOS control arm\textsuperscript{51}, and
...
manner in meta-analyses\textsuperscript{34}. From this model we focus on
...
healthy people\textsuperscript{52,53} though set with a conservative
...
women from two large studies of healthy people\textsuperscript{52,53}
...
mean\textsuperscript{54} we set this prior to reflect the range of
...
resolve\textsuperscript{13,37--39}. Thus the main models described above
...
timepoints such as mid- and post-intervention\textsuperscript{36,55,56}
...
al.\textsuperscript{38}. The PRISMA flow diagram
...
PCOS\textsuperscript{16,17,36,55--62}. One study used the 1990 National
Institutes of Health criteria\textsuperscript{63}, and two
studies\textsuperscript{18,57} diagnosed PCOS via the presence of
...
scanning. All but one study\textsuperscript{63}, which used doubly
...
reporting issues that were not resolved\textsuperscript{13,37--39} still
...
from studies involving interventions\textsuperscript{36,55,56}, in
...
associated with a slower metabolism\textsuperscript{26}, predisposing
...
others\textsuperscript{37--39} have numerous reporting errors which led
...
and psychologically safe approaches to care\textsuperscript{25,26}.
...
analysis\textsuperscript{64} reported that, whilst there was little
...
complications like obesity and insulin resistance\textsuperscript{65}.
...
eating in this population\textsuperscript{21,22,66,67}. The pathways
...
cravings, and appetite variability\textsuperscript{68}. Frequent
hypoglycaemia and associated mood changes have also been observed, which
can trigger compensatory eating or binge episodes\textsuperscript{68}.
...
eating\textsuperscript{69}. Moreover, eating disorders themselves can
disrupt endocrine function, potentially worsening PCOS symptoms and
creating a self-reinforcing cycle\textsuperscript{67,70}.
...
failure, hunger dysregulation, and shame\textsuperscript{71}. These
...
they are recommended in international guidelines
{[}moranEvidenceSummariesRecommendations2020;\textsuperscript{26}{]}.
...
guidelines recommending multiple approaches to management
{[}moranEvidenceSummariesRecommendations2020;\textsuperscript{26};\textsuperscript{20}{]}.
...
could not be clarified (e.g.,\textsuperscript{13,37--39}) and were
...
\bibitem[\citeproctext]{ref-moranEvidenceSummariesRecommendations2020}
\CSLLeftMargin{25. }%
\CSLRightInline{Moran LJ, Tassone EC, Boyle J, et al. Evidence summaries
and recommendations from the international evidence-based guideline for
the assessment and management of polycystic ovary syndrome: {Lifestyle}
management. \emph{Obesity Reviews}. 2020;21(10):e13046.
doi:\href{https://doi.org/10.1111/obr.13046}{10.1111/obr.13046}}
...
\bibitem[\citeproctext]{ref-nguoExploringPhysiologicalFactors2025}
\CSLLeftMargin{31. }%
\CSLRightInline{Nguo K, McGowan M, Cowan S, et al. Exploring the
physiological factors relating to energy balance in women with
polycystic ovary syndrome: A scoping review. \emph{Nutrition Reviews}.
2025;83(1):160-174.
doi:\href{https://doi.org/10.1093/nutrit/nuad169}{10.1093/nutrit/nuad169}}
...
\pandocbounded{\includegraphics[keepaspectratio]{submission_manuscript_files/figure-pdf/fig-mean-REE-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{submission_manuscript_files/figure-pdf/fig-variance-REE-1.pdf}}
